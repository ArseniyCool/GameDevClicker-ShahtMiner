...
stan = Stan()
coal = Ore_mine(pygame.image.load('textures/coal.png').convert_alpha(), 1, (700, 400), 0.425, 1)
copper = Ore_mine(pygame.image.load('textures/copper.png').convert_alpha(), 1, (1000, 400), 0.395, 3)
iron = Ore_mine(pygame.image.load('textures/iron.png').convert_alpha(), 1, (1300, 400), 0.615, 5)
